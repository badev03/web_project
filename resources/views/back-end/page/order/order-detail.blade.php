            ...
            <div class="card">
                <div class="card-body">
                    <div class="title-header title-header-block package-card">
                        <div>
                            <h5>Order #{{  $detail->order_code }}</h5>
                        </div>
                        <div class="card-order-section">
                            <ul>
                                <li>{{ $detail->created_at }}</li>
                                
                                <li>
                                    @foreach ($detail->orderDetails as $orderDetail)
                                        @if (is_array($orderDetail->product_id))
                                            {{ count($orderDetail->product_id) }}
                                        @else
                               ...
                               <li>Total {{number_format($detail->total_amount,0,',','.')}} VND</li>
                            </ul>
                        </div>
                    </div>
