            ...
            <div class="container-fluid">
                <div class="middel_inner">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="logo">
                                <a href="index.html"><img src="{{asset('template/reid/assets/img/logo/logo.png')}}" alt=""></a>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="cart_area">
    ...
    <div class="slider_area slider_style home_three_slider owl-carousel">
        <div class="single_slider" data-bgimg="{{asset('template/reid/assets/img/slider/slider4.png')}}">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content content_one">
                            <img src="{{asset('template/reid/assets/img/slider/content3.png')}}" alt="">
        ...
        <div class="single_slider" data-bgimg="{{asset('template/reid/assets/img/slider/slider5.png')}}">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content content_two">
                            <img src="{{asset('template/reid/assets/img/slider/content4.png')}}" alt="">
                            <p>the wooboom clothing summer collection is back at half price</p>
                            <a href="shop.html">Discover Now</a>
                        </div>    
                    </div>
        ...
        <div class="single_slider" data-bgimg="{{asset('template/reid/assets/img/slider/slider6.png')}}">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="slider_content content_three">
                            <img src="{{asset('template/reid/assets/img/slider/content5.png')}}" alt="">
                            <p>the wooboom clothing summer collection is back at half price</p>
                            <a href="shop.html">Discover Now</a>
                        </div>    
                    </div>
               ...
               <div class="col-lg-4 col-md-6">
                    <div class="banner_area">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('template/reid/assets/img/bg/banner8.jpg')}}" alt="#"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="banner_area">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('template/reid/assets/img/bg/banner9.jpg')}}" alt="#"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="banner_area bottom">
                        <div class="banner_thumb">
                            <a href="shop.html"><img src="{{asset('template/reid/assets/img/bg/banner10.jpg')}}" alt="#"></a>
                        </div>
                    </div>
                </div>
            </div>
